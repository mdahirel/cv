...
{{< fa mastodon >}} [\@mdahirel\@mastodon.social](https://mastodon.social/@mdahirel)\
...
### Main study taxa {#taxa}

![snail](images/cornu-aspersum_gareth-monger-phylopic.png){width=10%}  ![orbweaver](images/araneus-diadematus_birgit-lang-phylopic.png){width=10%}

**Rearing**  
**Trait measurements**  
**Behavioural test observations**   
**Field sampling**  
...
- **dispersal** as a key trait bridging ecological and evolutionary dynamics.
...
|      \small{{< fa calendar >}} 2020 - present \normalsize
